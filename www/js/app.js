...
lab2.factory('processMove', function() {
  return function() {
    self.checkWins =  function(player1_choice, player2_choice) {
      ...
      if (angular.equals(a, 'rock')) {
        if (angular.equals(b, 'paper')){
          return 2;
        }
        return 1;
      }
      if (angular.equals(a, 'paper')) {
        if (angular.equals(b, 'scissors')){
          return 2;
        }
        return 1;
      }
      if (angular.equals(a, 'scissors')) {
        if (angular.equals(b, 'rock')){
          return 2;
        }
        return 1;
      }
